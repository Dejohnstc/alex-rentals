...
export default function Home() {
  ...
  email: email,
  name: "Customer",
  phone_number: "0000000000", // ✅ required
},
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-[#0a0a0a] to-[#111111] px-4">
      ...
      <footer className="absolute bottom-4 text-center text-xs text-gray-500">
        ...
        <p>
          ...
          <a
            href="mailto:alexsobieskki@gmail.com"
